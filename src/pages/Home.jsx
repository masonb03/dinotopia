...
export default function Home() {
  ...
  return (
    <div className='home-welcome'>
      <h1>Back then...</h1>
      <p>Million of years ago, the earth we reside on, was once very different. Ruled by the most powerful animals the world has ever seen in histroy. Across multiple time periods have these creatrues walked and now you have a chance to learn about these animals in their glory. Venture on and be amazed of the great rulers of earth from the past.</p>
